...
addPubSubConnection(UA_Server *server, UA_String *transportProfile,
    ...
    UA_LOG_INFO(UA_Log_Stdout, UA_LOGCATEGORY_USERLAND, "addPubSubConnection is executed");
...
/*
    ...
    UA_Variant  value2 = (UA_Variant) dataSetFieldConfig.field.variable.publishParameters.substituteValue;
//    UA_DateTime time_info = *(UA_DateTime *) published_Data.data;
//    UA_DateTimeStruct ali = UA_DateTime_toStruct(time_info);

    UA_DateTime value = (UA_DateTime) value2.data;
    UA_DateTimeStruct dts = UA_DateTime_toStruct(value);
...
static void
addVariableDataSetField(UA_Server *server, int nsIndex, char* qualifier){
    /* Add a field to the previous created PublishedDataSet */
    UA_NodeId dataSetFieldIdent;
    UA_DataSetFieldConfig dataSetFieldConfig;
    memset(&dataSetFieldConfig, 0, sizeof(UA_DataSetFieldConfig));
...
static int run(UA_String *transportProfile,
    ...
    addVariableDataSetField(server, 1, "the.answer");
